...
LIBNDS="libnds-1.5.7.tar.bz2"
LIBFILESYSTEM="libfilesystem-0.9.9.tar.bz2"
LIBFAT="libfat-nds-1.0.11.tar.bz2"
MAXMOD="maxmod-nds-1.0.7.tar.bz2"
DSWIFI="dswifi-0.3.15.tar.bz2"
EXAMPLES="nds-examples-20120410.tar.bz2"
